...
A library to deal with the message Framing problem in tcp it has 2 methods a safe send method which sends the size of a message before the message is sent then the actual message nd a recieve method which recieves from the safe send method.
